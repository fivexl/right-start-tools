...
class Organizations:
    ...
    def get_org_structure(self, root_id: str) -> OrgStructure:
        ...
        master_account = Account.from_dict(self.client.describe_account(AccountId=master_account_id)['Account'])
...
class STS:
    ...
    def assume_role_and_get_credentials(self, account_id: str, role_name: str, session_name: str = 'AssumeRoleSession'):
